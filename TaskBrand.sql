...
Select NoteBooks.Name,Brand.Name 'BrandName',NoteBooks.Price from NoteBooks inner join Brand on NoteBooks.BrandID=Brand.ID where (NoteBooks.Price>2000 and NoteBooks.Price<5000) or NoteBooks.Price>5000
Select Phones.Name,Brand.Name 'BrandName',Phones.Price  from Phones inner join Brand on Phones.BrandID=Brand.ID where (Phones.Price>1000 and Phones.Price<1500) or Phones.Price>1500
...
Select n.Name ,p.Name from NoteBooks n cross join  Phones p where n.BrandID=p.BrandID
